...
static_assert(xs::host::XS_MANAGED_ABI_VERSION == 7u,
...
static_assert(sizeof(xs::host::ManagedNativeCallbacks) == 56u,
              "ManagedNativeCallbacks must remain ABI compatible with managed interop.");
static_assert(sizeof(xs::host::ManagedInitArgs) == 104u,
