...
static_assert(std::is_same_v<decltype(std::declval<const xs::host::ManagedRuntimeHost&>().AreGameExportsBound()), bool>,
              "ManagedRuntimeHost::AreGameExportsBound must return bool.");
static_assert(
    std::is_same_v<decltype(std::declval<const xs::host::ManagedRuntimeHost&>().AreServerStubCatalogExportsBound()),
                   bool>,
...
static_assert(std::is_same_v<decltype(&xs::host::ManagedRuntimeHost::BindGameExports),
                             xs::host::ManagedHostErrorCode (xs::host::ManagedRuntimeHost::*)()>,
              "ManagedRuntimeHost::BindGameExports must return only ManagedHostErrorCode.");
static_assert(std::is_same_v<decltype(&xs::host::ManagedRuntimeHost::GetGameExports),
                             xs::host::ManagedHostErrorCode (xs::host::ManagedRuntimeHost::*)(
                                 xs::host::ManagedGameExports&) const noexcept>,
              "ManagedRuntimeHost::GetGameExports must return only ManagedHostErrorCode plus output exports.");
static_assert(std::is_same_v<decltype(&xs::host::ManagedRuntimeHost::BindServerStubCatalogExports),
                             xs::host::ManagedHostErrorCode (xs::host::ManagedRuntimeHost::*)()>,
              "ManagedRuntimeHost::BindServerStubCatalogExports must return only ManagedHostErrorCode.");
static_assert(
    std::is_same_v<decltype(&xs::host::ManagedRuntimeHost::GetServerStubCatalogExports),
                   xs::host::ManagedHostErrorCode (xs::host::ManagedRuntimeHost::*)(
                       xs::host::ManagedServerStubCatalogExports&) const noexcept>,
    "ManagedRuntimeHost::GetServerStubCatalogExports must return only ManagedHostErrorCode plus output exports.");
static_assert(xs::host::XS_MANAGED_ABI_VERSION == 3u,
              "Managed ABI version must remain aligned with docs/MANAGED_INTEROP.md.");
...
static_assert(sizeof(xs::host::ManagedNativeCallbacks) == 24u,
              "ManagedNativeCallbacks must remain ABI compatible with managed interop.");
static_assert(sizeof(xs::host::ManagedInitArgs) == 72u,
...
static_assert(sizeof(xs::host::ManagedServerStubCatalogEntry) == 272u,
              "ManagedServerStubCatalogEntry must remain ABI compatible with managed interop.");
static_assert(offsetof(xs::host::ManagedServerStubCatalogEntry, entity_id_utf8) >
