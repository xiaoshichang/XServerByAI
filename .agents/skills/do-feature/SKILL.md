...
2. Prepare a new branch named exactly the feature id (e.g., `M1-01`). If missing, create it.
...
6. If the latest commit on the branch is not from `tester` or `human`, wait for their feedback before iterating.
