...
7. M3-07 实现 GM 管理命令接口（本地 CLI 或 HTTP）。Deps: M3-02 | 状态: 开发中
8. M3-08 实现 Gate 角色启动骨架与 GM Inner 链路接入。Deps: M3-01, M2-07 | 状态: 未开发
9. M3-09 实现 Gate→GM 注册与心跳。Deps: M3-08, M2-11, M2-12 | 状态: 未开发
10. M3-10 实现 Game 角色启动骨架与 GM Inner 链路接入。Deps: M3-01, M2-07 | 状态: 未开发
